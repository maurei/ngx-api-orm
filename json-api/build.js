...
const PACKAGE = `ngx-api-orm-json-api`;
const NPM_DIR = `dist`;
...
if (
	shell.exec(
		`uglifyjs ${PACKAGE}.umd.js -c --comments -o ${PACKAGE}.umd.min.js --source-map "includeSources=true,filename='${PACKAGE}.umd.min.js.map'"`
	).code !== 0
) {
